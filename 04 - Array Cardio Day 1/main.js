// Get your shorts on - this is an array workout!
    ...
    // refactor
    const sortedInventors2 = inventors.sort( (a, b) => a < b ? -1 : 1);
    //console.table(sortedInventors2);

    // Array.prototype.reduce()
    // 4. How many years did all the inventors live all together?
    const totalYears = inventors.reduce( (allYears, inventor) => allYears += (inventor.passed - inventor.year), 0);
    //console.log(`Collectively, all the inventors lived for a total of ${totalYears} years!`);
